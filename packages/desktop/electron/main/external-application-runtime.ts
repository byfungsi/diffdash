...
export const createExternalApplicationRuntime = (
  ...
  const core: ApplicationRuntime["core"] = {
    ...
    listLocalCheckoutFiles: (input) =>
      invoke((client) => client.listLocalCheckoutFiles({ ...requestContext(), ...input })),
    readLocalCheckoutFile: (input) =>
      invoke((client) => client.readLocalCheckoutFile({ ...requestContext(), ...input })),
