...
import { OpenHostedReviewFileRequest } from "@diffdash/protocol/hosted-git"
...
export const defineNavigationHandlers = (
  ...
  handlers.define(InvokeChannel.appOpenExternalUrl, async (_event, url: string): Promise<void> => {
