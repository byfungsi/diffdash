...
const fakeGitProviderLayer = (options: {
  ...
  return Layer.succeed(
    ...
    GitProvider.of({
      ...
      updateHostedReviewBranch: () => unavailableProviderMethod(),
      listHostedReviewChecks: () => unavailableProviderMethod(),
      getReviewDecision: () => unavailableProviderMethod(),
      closeReview: () => unavailableProviderMethod(),
      mergeReview: () => unavailableProviderMethod(),
