...
| D-10 | Fixed-space literal search scan, acceleration, cursor, excerpt, and near-every-line match behavior | Provisional 2026-08-16 algorithm and progressive RPC/renderer integration evidence in [`m21-search-2026-08-16.md`](m21-search-2026-08-16.md); packaged scale measurement remains |
